...
class Stagemodule(nn.Module):
    def __init__(self,in_channels,out_channels,kernel_size,padding):
        ...
        self.eca_conv = nn.ModuleList([
            ECAblock(in_channels, out_channels, kernel_size=kernel_size,padding=padding,stride=stride)
...
if __name__ == '__main__':
    ...
    #print(fe)
    net = SCRBnetV2(in_channels, out_channels=8,masks=masks_tensor,scale=1.001)
    print(net)
    y = net(input_tensor)
    print(y.shape)
