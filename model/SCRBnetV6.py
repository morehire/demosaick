...
if __name__ == '__main__':
    ...
    #print(fe)
    net = SCRBnetV6(in_channels=1, out_channels=8,masks=masks_tensor)
    print(net)
    y = net(input_tensor)
    print(y.shape)
